        ...
        <Fragment>
            ...
            <div className="inrPgCnt dbPrf">
				<div className="container">
					<Dashboard />
					<div className="dbFlt">
						<div className="dbFltTl">Invested project</div>
					...
					<div className="dbPrjsCn">
						...
						<div className="dbPrjCd">
							<div className="dbPrjCdC">
								<div className="dpjcLbl">Project Name</div>
								<div className="dpjcIgTl">
									<div className="dpjcIg">
										<img src={nft10Img} alt="nft" />
									</div>
									<div className="dpjcTl">
										<div className="dpjcNm">Visual Creative Arts</div>
									</div>
								</div>
							</div>

							<div className="dbPrjCdC">
								<div className="dpjcLbl">Share Amount</div>
								<div className="dpjcVal">$35.43</div>
							</div>

							<div className="dbPrjCdC">
								<div className="dpjcLbl">Total share count</div>
								<div className="dpjcVal">01</div>
							</div>

							<div className="dbPrjCdC">
								<div className="dpjcLbl">Status</div>
								<div className="dpjcVal text-green">Completed</div>
							</div>
						</div>
