...
const InnerFooter = (props) => {
    ...
    return (
        <Fragment>
           <footer className="crFt">
                <div className="container">
                    <div className="row crFtR">
                        <div className="col-md-auto crFtC">
                            <div className="cpTx">
                                &copy; Copyright 2022 - 2023 House of Crypto All rights reserved.
                            </div>
                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <svg width="32" height="18" viewBox="0 0 32 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M31.1329 11.1102C31.0883 11.6922 31.0528 12.2758 30.9963 12.8553C30.8945 13.9073 30.7736 14.9552 30.4556 15.9471C30.3938 16.1604 30.3019 16.3581 30.1843 16.5307C29.9872 16.804 29.7684 16.8015 29.5772 16.5192C29.4248 16.276 29.3098 15.9993 29.2382 15.7034C28.9268 14.5881 28.8111 13.4249 28.7165 12.2594C28.6046 10.8057 28.573 9.34418 28.6219 7.88512C28.6706 6.27174 28.7737 4.66412 29.1055 3.09436C29.1813 2.68278 29.3062 2.28789 29.476 1.92302C29.7322 1.40937 30.0312 1.40114 30.2861 1.91232C30.5784 2.49758 30.6928 3.16598 30.8005 3.83109C30.9626 4.84907 31.0629 5.88096 31.1008 6.91791C31.1076 6.99904 31.1184 7.07958 31.1329 7.15909V11.1102Z" fill="black"></path>
                                            <path d="M0.734144 9.12718C0.675267 4.55348 4.38614 0.269032 9.59184 0.266602C14.7239 0.266602 18.4782 4.45221 18.4667 9.15392C18.4553 13.8556 14.6978 18.0096 9.58039 17.9999C4.4025 17.991 0.672814 13.7341 0.734144 9.12718Z" fill="black"></path>
                                            <path d="M18.4668 9.13116C18.5091 7.13813 18.7757 5.19413 19.5553 3.35851C19.8804 2.58951 20.2925 1.87384 20.8607 1.27688C22.141 -0.070158 23.6969 -0.070158 24.9707 1.27688C25.7462 2.10007 26.2331 3.1125 26.5916 4.20148C27.0434 5.60594 27.2901 7.0751 27.3232 8.55828C27.389 10.5892 27.1435 12.5633 26.4485 14.4634C26.1087 15.3924 25.6535 16.2534 24.9853 16.9674C23.7034 18.3385 22.1402 18.3437 20.8542 16.9854C20.0853 16.1717 19.6016 15.1687 19.2431 14.0961C18.7902 12.7369 18.5422 11.3108 18.5083 9.87005C18.5083 9.62318 18.4822 9.37717 18.4668 9.13116Z" fill="black"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li>
